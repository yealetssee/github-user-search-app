...
import NightMode from "/public/assets/icon-moon.svg";
import LightMode from "/public/assets/icon-sun.svg";
  ...
  return (
    <main>
      <div className="head">
        ...
        <div className="color-mode" onClick={() => setIsDark(!isDark)}>
          <span>{isDark ? "Light" : "Dark"}</span>
          <div className="icon">
            <img src={isDark ? LightMode : NightMode} alt="moon-icon" />
          </div>
        </div>
      </div>
          ...
          <div className="user-card">
            <div className="user-card_main">
              ...
              <div className="content-right">
                ...
                <p>
                  <a href={searchResult.html_url}>{`@${searchResult.login}`}</a>
                </p>
                <p>{searchResult.created_at.substring(0, 10)}</p>
              </div>
            </div>
            ...
            <div className="user-info">
                ...
                <span>
                  ...
                  >
                    <path
                      ...
                      fill={searchResult.location ? null : "#4b6a9b"}
                    />
                  </svg>
                </span>
                <span
                  style={{ color: searchResult.location ? null : "#4b6a9b" }}
                >
              ...
              <div>
                <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                  <g>
                    <path
                      ...
                      fill={searchResult.blog ? null : "#4b6a9b"}
                    />
                    <path
                ...
                <span style={{ color: searchResult.blog ? null : "#4b6a9b" }}>
                  {searchResult.blog ? searchResult.blog : "Not Avaliable"}
                </span>
              </div>
              <div>
                <span>
                  ...
                  >
                    <path
                      ...
                      fill={searchResult.twitter_username ? null : "#4b6a9b"}
                    />
                  </svg>
                </span>
                <span
                  style={{
                    color: searchResult.twitter_username ? null : "#4b6a9b",
                  }}
                >
                  {searchResult.twitter_username
                    ? searchResult.twitter_username
                    : "Not Avaliable"}
                </span>
              </div>
                  ...
                  >
                    <g>
                      <path
                        ...
                        fill={searchResult.company ? null : "#4b6a9b"}
                      />
                    </g>
                  </svg>
                </span>
                <span
                  style={{ color: searchResult.company ? null : "#4b6a9b" }}
                >
